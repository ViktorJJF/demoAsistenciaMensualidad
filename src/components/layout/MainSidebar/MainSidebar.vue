<template>
  ...
  >
    <div class="main-navbar">
      ...
      >
        <a class="company-name w-100 mr-0" href="#" style="line-height: 25px;">
          <div class="d-table m-auto">
            <img
              ...
              alt="Logia Francisco de Paula Gonzáles Vigil N° 38"
            />
            <span
              v-if="!hideLogoText"
              class="d-none d-md-inline mr-1"
            >Logia Francisco de Paula Gonzáles Vigil N° 38</span>
          </div>
        </a>
